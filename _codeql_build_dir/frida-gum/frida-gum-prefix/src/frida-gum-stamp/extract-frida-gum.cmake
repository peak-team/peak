...
#
get_filename_component(filename "/home/runner/work/peak/peak/_codeql_build_dir/frida-gum/frida-gum-prefix/src/frida-gum-devkit-16.5.9-linux-x86_64.tar.xz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/peak/peak/_codeql_build_dir/frida-gum/frida-gum-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-frida-gum${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-frida-gum${i}")
